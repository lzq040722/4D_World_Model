...
prompt = (
    ...
    "Match the perspective, composition, lighting, color tone, texture, and visual style of the original image. "
    "Make the water surface especially continuous across the mask boundary, with matching reflections, ripples, brightness, and shadow direction. "
    "Preserve the visible content and blend the completed region naturally."
    "Generate a clear, sharp, high-quality image with crisp details and no blur."
)
